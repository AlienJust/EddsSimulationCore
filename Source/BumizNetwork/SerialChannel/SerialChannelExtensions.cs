...
namespace BumizNetwork.SerialChannel {
  ...
  static class SerialChannelExtensions {
    ...
    public static List<byte>
      ReadInteleconCommand(this SerialPortStream port, ushort? netAddress, int timeoutInSeconds) {
      ...
      Log.Log(
        "Истекло время ожидания ответа, будет произведено удаление всех принятых данных из буфера последовательного канала...");
