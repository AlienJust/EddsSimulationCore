namespace Bumiz.Apply.PulseCounterArchiveReader {
  class IntegralData : IIntegralData {
    public IntegralData(int impulsesCount1, int impulsesCount2, int impulsesCount3, int recordsCount,
      int correctRecordsCount, int incorrectRecordsCount, int supposedRecordsCount) {
