...
namespace Bumiz.Apply.PulseCounterArchiveReader {
  public interface IPulseCounterDataStorage {
    IIntegralData
      GetIntegralData(string objectName,
        DateTime upToTime); // TODO: can be moved to another interface, cause it used to give data to upper system
    ...
    void SaveData(string objectName, DateTime time, bool isRecordCorrect, int pulseCount1, int pulseCount2,
