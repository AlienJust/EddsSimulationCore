...
namespace nMqtt
{
    public class MqttConnAj
    {
        ...
        public MqttConnAj(string host, int port, string username, string password)
        {
            ...
            _receiveWorker = new SingleThreadedRelayQueueWorkerProceedAllItemsBeforeStopNoLog<Action>("ReceiveMqtt", a=>a(), ThreadPriority.BelowNormal, true, null);
            _sendingWorker = new SingleThreadedRelayQueueWorkerProceedAllItemsBeforeStopNoLog<Action>("SendingMqtt", a=>a(), ThreadPriority.BelowNormal, true, null);
